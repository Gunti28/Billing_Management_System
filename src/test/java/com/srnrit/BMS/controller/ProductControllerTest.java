...
class ProductControllerTest {
	...
	void testAddProductByCategory_Success() throws Exception {
		...
		when(productService.storeProduct(any(ProductRequestDTO.class))).thenReturn(responseDTO);
		...
		verify(productService, times(1)).storeProduct(any(ProductRequestDTO.class));
	}

	// 1.1 Add Product by Category (Category Not Found)
	@Test
	void testAddProductByCategory_CategoryNotFound() throws Exception {
		when(productService.storeProduct(any(ProductRequestDTO.class)))
	...
	void testUpdateProduct_Success() throws Exception {
		...
		ProductRequestDTO requestDTO = new ProductRequestDTO("category001", "Updated Mutton SP Biryani", null, 0,
				1190.67, false); // Use `null` for MultipartFile
